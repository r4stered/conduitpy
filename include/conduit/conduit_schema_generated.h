...
#ifndef CONDUITPY_INCLUDE_CONDUIT_CONDUIT_SCHEMA_GENERATED_H_
#define CONDUITPY_INCLUDE_CONDUIT_CONDUIT_SCHEMA_GENERATED_H_
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) Joystick FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  Joystick(uint8_t _type, int16_t _axis_count, uint8_t _button_count,
           int32_t _buttons, int16_t _pov_count, bool _is_xbox)
      : name_(),
  ...
  Joystick(::flatbuffers::span<const uint8_t, 256> _name, uint8_t _type,
           int16_t _axis_count,
           ::flatbuffers::span<const uint8_t, 12> _axis_types,
           ::flatbuffers::span<const float, 12> _axis_values,
           uint8_t _button_count, int32_t _buttons, int16_t _pov_count,
           ::flatbuffers::span<const int16_t, 12> _pov_values, bool _is_xbox)
      : type_(::flatbuffers::EndianScalar(_type)),
        padding0__(0),
        axis_count_(::flatbuffers::EndianScalar(_axis_count)),
        button_count_(::flatbuffers::EndianScalar(_button_count)),
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) DSData FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  DSData(int32_t _alliance_station, uint16_t _game_specific_message_size,
         uint16_t _match_number, uint8_t _replay_number, int32_t _match_type,
         int32_t _control_word, double _match_time)
      : alliance_station_(::flatbuffers::EndianScalar(_alliance_station)),
        event_name_(),
        game_specific_message_size_(
            ::flatbuffers::EndianScalar(_game_specific_message_size)),
        game_specific_message_(),
  ...
  DSData(int32_t _alliance_station,
         ::flatbuffers::span<const uint8_t, 64> _event_name,
         uint16_t _game_specific_message_size,
         ::flatbuffers::span<const uint8_t, 64> _game_specific_message,
         uint16_t _match_number, uint8_t _replay_number, int32_t _match_type,
         int32_t _control_word, double _match_time,
         ::flatbuffers::span<
             const org::littletonrobotics::conduit::schema::Joystick, 6>
             _joysticks)
      : alliance_station_(::flatbuffers::EndianScalar(_alliance_station)),
        game_specific_message_size_(
            ::flatbuffers::EndianScalar(_game_specific_message_size)),
    ...
    ::flatbuffers::CastToArray(game_specific_message_)
        .CopyFromSpan(_game_specific_message);
    (void)padding0__;
    (void)padding1__;
    (void)padding2__;
  ...
  void mutate_game_specific_message_size(uint16_t _game_specific_message_size) {
    ::flatbuffers::WriteScalar(&game_specific_message_size_,
                               _game_specific_message_size);
  }
  ...
  const ::flatbuffers::Array<org::littletonrobotics::conduit::schema::Joystick,
                             6>*
  joysticks() const {
    return &::flatbuffers::CastToArray(joysticks_);
  }
  ::flatbuffers::Array<org::littletonrobotics::conduit::schema::Joystick, 6>*
  mutable_joysticks() {
    return &::flatbuffers::CastToArray(joysticks_);
  }
};
...
inline bool operator==(const DSData& lhs, const DSData& rhs) {
  return (lhs.alliance_station() == rhs.alliance_station()) &&
         (*lhs.event_name() == *rhs.event_name()) &&
         (lhs.game_specific_message_size() ==
          rhs.game_specific_message_size()) &&
 ...
 public:
  ...
  PDPData()
      : handle_(0),
        ...
        total_power_(0),
        total_energy_(0) {}
  PDPData(int32_t _handle, int32_t _channel_count, int32_t _type,
          int32_t _module_id, uint32_t _faults, uint32_t _sticky_faults,
          double _temperature, double _voltage, double _total_current,
          double _total_power, double _total_energy)
  ...
  PDPData(int32_t _handle, int32_t _channel_count, int32_t _type,
          int32_t _module_id, uint32_t _faults, uint32_t _sticky_faults,
          double _temperature, double _voltage,
          ::flatbuffers::span<const double, 24> _channel_current,
          double _total_current, double _total_power, double _total_energy)
      : handle_(::flatbuffers::EndianScalar(_handle)),
        channel_count_(::flatbuffers::EndianScalar(_channel_count)),
        type_(::flatbuffers::EndianScalar(_type)),
        module_id_(::flatbuffers::EndianScalar(_module_id)),
...
inline bool operator==(const PDPData& lhs, const PDPData& rhs) {
  return (lhs.handle() == rhs.handle()) &&
         ...
         (lhs.type() == rhs.type()) && (lhs.module_id() == rhs.module_id()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(4) CANStatus FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  CANStatus(float _percent_bus_utilization, uint32_t _bus_off_count,
            uint32_t _tx_full_count, uint32_t _receive_error_count,
            uint32_t _transmit_error_count)
      : percent_bus_utilization_(
            ::flatbuffers::EndianScalar(_percent_bus_utilization)),
        ...
        transmit_error_count_(
            ::flatbuffers::EndianScalar(_transmit_error_count)) {}
  ...
  void mutate_percent_bus_utilization(float _percent_bus_utilization) {
    ::flatbuffers::WriteScalar(&percent_bus_utilization_,
                               _percent_bus_utilization);
  }
...
inline bool operator==(const CANStatus& lhs, const CANStatus& rhs) {
  return (lhs.percent_bus_utilization() == rhs.percent_bus_utilization()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) SystemData FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  SystemData(
      int32_t _fpga_version, int32_t _fpga_revision,
      uint16_t _serial_number_size, uint16_t _comments_size,
      int32_t _team_number, int32_t _fpga_button, int32_t _system_active,
      int32_t _browned_out, int32_t _comms_disable_count, int32_t _rsl_state,
      int32_t _system_time_valid, double _voltage_vin, double _current_vin,
      double _user_voltage_3v3, double _user_current_3v3,
      int32_t _user_active_3v3, int32_t _user_current_faults_3v3,
      double _user_voltage_5v, double _user_current_5v, int32_t _user_active_5v,
      int32_t _user_current_faults_5v, double _user_voltage_6v,
      double _user_current_6v, int32_t _user_active_6v,
      int32_t _user_current_faults_6v, double _brownout_voltage,
      double _cpu_temp,
      const org::littletonrobotics::conduit::schema::CANStatus& _can_status,
      uint64_t _epoch_time)
      : fpga_version_(::flatbuffers::EndianScalar(_fpga_version)),
        ...
        user_current_faults_3v3_(
            ::flatbuffers::EndianScalar(_user_current_faults_3v3)),
        ...
        user_current_faults_5v_(
            ::flatbuffers::EndianScalar(_user_current_faults_5v)),
        ...
        user_current_faults_6v_(
            ::flatbuffers::EndianScalar(_user_current_faults_6v)),
  ...
  SystemData(
      int32_t _fpga_version, int32_t _fpga_revision,
      uint16_t _serial_number_size,
      ::flatbuffers::span<const uint8_t, 8> _serial_number,
      uint16_t _comments_size, ::flatbuffers::span<const uint8_t, 64> _comments,
      int32_t _team_number, int32_t _fpga_button, int32_t _system_active,
      int32_t _browned_out, int32_t _comms_disable_count, int32_t _rsl_state,
      int32_t _system_time_valid, double _voltage_vin, double _current_vin,
      double _user_voltage_3v3, double _user_current_3v3,
  ...
  void mutate_user_current_faults_3v3(int32_t _user_current_faults_3v3) {
    ::flatbuffers::WriteScalar(&user_current_faults_3v3_,
                               _user_current_faults_3v3);
  }
  ...
  void mutate_user_current_faults_5v(int32_t _user_current_faults_5v) {
    ::flatbuffers::WriteScalar(&user_current_faults_5v_,
                               _user_current_faults_5v);
  }
  ...
  void mutate_user_current_faults_6v(int32_t _user_current_faults_6v) {
    ::flatbuffers::WriteScalar(&user_current_faults_6v_,
                               _user_current_faults_6v);
  }
...
inline bool operator==(const SystemData& lhs, const SystemData& rhs) {
  return (lhs.fpga_version() == rhs.fpga_version()) &&
...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) CoreInputs FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  CoreInputs() : timestamp_(0), ds_(), pdp_(), sys_() {}
  CoreInputs(int64_t _timestamp,
             const org::littletonrobotics::conduit::schema::DSData& _ds,
             const org::littletonrobotics::conduit::schema::PDPData& _pdp,
             const org::littletonrobotics::conduit::schema::SystemData& _sys)
...
inline bool operator==(const CoreInputs& lhs, const CoreInputs& rhs) {
  return (lhs.timestamp() == rhs.timestamp()) && (lhs.ds() == rhs.ds()) &&
         (lhs.pdp() == rhs.pdp()) && (lhs.sys() == rhs.sys());
}
...
inline const ::flatbuffers::TypeTable* JoystickTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      ...
      {::flatbuffers::ET_SHORT, 0, -1}, {::flatbuffers::ET_UCHAR, 1, -1},
      {::flatbuffers::ET_FLOAT, 1, -1}, {::flatbuffers::ET_UCHAR, 0, -1},
      {::flatbuffers::ET_INT, 0, -1},   {::flatbuffers::ET_SHORT, 0, -1},
      {::flatbuffers::ET_SHORT, 1, -1}, {::flatbuffers::ET_BOOL, 0, -1}};
  ...
  static const int64_t values[] = {0,   256, 258, 260, 272, 320,
                                   324, 328, 330, 354, 356};
  static const char* const names[] = {
      "name",         "type",    "axis_count", "axis_types", "axis_values",
      "button_count", "buttons", "pov_count",  "pov_values", "is_xbox"};
...
inline const ::flatbuffers::TypeTable* DSDataTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      {::flatbuffers::ET_INT, 0, -1},    {::flatbuffers::ET_UCHAR, 1, -1},
      {::flatbuffers::ET_USHORT, 0, -1}, {::flatbuffers::ET_UCHAR, 1, -1},
      {::flatbuffers::ET_USHORT, 0, -1}, {::flatbuffers::ET_UCHAR, 0, -1},
      {::flatbuffers::ET_INT, 0, -1},    {::flatbuffers::ET_INT, 0, -1},
      {::flatbuffers::ET_DOUBLE, 0, -1}, {::flatbuffers::ET_SEQUENCE, 1, 0}};
  ...
  static const int64_t values[] = {0,   4,   68,  70,  134, 136,
                                   140, 144, 152, 160, 2296};
  static const char* const names[] = {"alliance_station",
                                      "event_name",
...
inline const ::flatbuffers::TypeTable* PDPDataTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      ...
      {::flatbuffers::ET_DOUBLE, 1, -1}, {::flatbuffers::ET_DOUBLE, 0, -1},
      {::flatbuffers::ET_DOUBLE, 0, -1}, {::flatbuffers::ET_DOUBLE, 0, -1}};
  static const int16_t array_sizes[] = {
      24,
  };
  static const int64_t values[] = {0,  4,  8,   12,  16,  20, 24,
                                   32, 40, 232, 240, 248, 256};
  static const char* const names[] = {
      "handle",          "channel_count", "type",        "module_id",
      "faults",          "sticky_faults", "temperature", "voltage",
      "channel_current", "total_current", "total_power", "total_energy"};
  static const ::flatbuffers::TypeTable tt = {::flatbuffers::ST_STRUCT,
                                              12,
                                              type_codes,
                                              nullptr,
...
inline const ::flatbuffers::TypeTable* CANStatusTypeTable() {
  ...
  static const char* const names[] = {
      "percent_bus_utilization", "bus_off_count", "tx_full_count",
      "receive_error_count", "transmit_error_count"};
...
inline const ::flatbuffers::TypeTable* SystemDataTypeTable() {
  static const ::flatbuffers::TypeCode type_codes[] = {
      ...
      {::flatbuffers::ET_DOUBLE, 0, -1}, {::flatbuffers::ET_DOUBLE, 0, -1},
      {::flatbuffers::ET_DOUBLE, 0, -1}, {::flatbuffers::ET_INT, 0, -1},
      {::flatbuffers::ET_INT, 0, -1},    {::flatbuffers::ET_DOUBLE, 0, -1},
      {::flatbuffers::ET_DOUBLE, 0, -1}, {::flatbuffers::ET_INT, 0, -1},
      {::flatbuffers::ET_INT, 0, -1},    {::flatbuffers::ET_DOUBLE, 0, -1},
      {::flatbuffers::ET_DOUBLE, 0, -1}, {::flatbuffers::ET_INT, 0, -1},
      {::flatbuffers::ET_INT, 0, -1},    {::flatbuffers::ET_DOUBLE, 0, -1},
      {::flatbuffers::ET_DOUBLE, 0, -1}, {::flatbuffers::ET_SEQUENCE, 0, 0},
  ...
  static const int64_t values[] = {0,   4,   8,   10,  18,  20,  84,  88,
                                   92,  96,  100, 104, 108, 112, 120, 128,
                                   136, 144, 148, 152, 160, 168, 172, 176,
                                   184, 192, 196, 200, 208, 216, 240, 248};
  static const char* const names[] = {"fpga_version",
                                      "fpga_revision",
                                      "serial_number_size",
                                      "serial_number",
                                      "comments_size",
...
inline const ::flatbuffers::TypeTable* CoreInputsTypeTable() {
  ...
  static const char* const names[] = {"timestamp", "ds", "pdp", "sys"};
  static const ::flatbuffers::TypeTable tt = {::flatbuffers::ST_STRUCT,
                                              4,
                                              type_codes,
                                              type_refs,
...
#endif  // CONDUITPY_INCLUDE_CONDUIT_CONDUIT_SCHEMA_GENERATED_H_
